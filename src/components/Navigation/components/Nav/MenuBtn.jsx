  ...
  return (
    ...
    >
      <div className="relative w-[40px] h-[20px]">
        <div
          className={`w-full h-[1.5px] absolute left-0 top-0 transition-all ease-[cubic-bezier(0.4,0,0.2,1)] duration-200
            ${menuActive ? "-rotate-45 translate-y-2 !bg-white" : ""} ${atTop && !isLightPage ? "bg-white" : "bg-black"}`}
        ></div>
        <div
