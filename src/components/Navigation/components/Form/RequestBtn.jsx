...
export default function RequestBtn({ toggleModal, atTop, activeDropdown }) {
  return (
    <button
      onClick={toggleModal}
      className={`relative group ${atTop || activeDropdown ? "border-white" : "border-black"} z-[9999] max-w-[300px] border-[2px] cursor-pointer 
