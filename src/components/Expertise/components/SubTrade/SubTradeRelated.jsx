...
export default function SubTradeRelated({ trade, services = [] }) {
  ...
  return (
    <section className="550:pt-12 550:pb-12 py-8" id="subtrade_related">
      <div className="max-w-[1680px] 700:px-[1rem] mx-auto w-full px-[0.5rem]">
        <div className="1440:mx-auto 1440:w-[83.333%] w-full">
          <div className="w-full px-2 text-center pointer-events-none">
        ...
        <div className="relative overflow-hidden pt-12 lg:pt-16">
                  ...
                  <div className="h-full w-full flex flex-col">
                    <div className="flex flex-col flex-grow pb-6 pl-6 pt-6 border-t border-l transition-colors border-black/25 group-hover:border-third">
                      <div className="pointer-events-none mb-6">
                        <h3 className="pb-1 font-bold text-2xl h-[75px] leading-tight transition-colors group-hover:text-third">
                          {label}
                        </h3>
          ...
          <div className="px-2 mt-12 lg:mt-16 text-center">
            <Link
              href={trade.href}
          ...
          before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-0.5 before:w-full before:bg-[#0d0c0c] hover:before:bg-third"
            >
              <span className="relative">View All <span className="max-550:hidden">{trade.title}</span> Services</span>
            </Link>
          </div>
        </div>
      </div>
