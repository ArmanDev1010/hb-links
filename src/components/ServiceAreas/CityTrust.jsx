    ...
    <div className="mt-3 py-10 pb-[40px] text-black max-550:pb-[30px]">
      <div className="w-full lg:w-10/12 lg:mx-auto px-2 text-center">
        ...
        <h2 className="font-gt pb-1 font-semibold text-3xl 400:text-4xl 1080:text-5xl leading-[1] pointer-events-none">
          {city.name}'s Trusted Partner for{" "}
          <span className="text-third">Dependable Service</span>
        </h2>
        <p className="mt-8 text-gray-700 lg:mx-auto lg:max-w-2xl pointer-events-none">
          HB Links is a general contracting company serving {city.name} and
          the surrounding {city.countyName}, providing renovation,
          electrical, plumbing, and low-voltage services under one contract.
          We communicate clearly, respect your property, and show up when we
          say we will.
        </p>
        ...
        >
          Schedule a Free Inspection in {city.name}
        </button>
      </div>
    </div>
  );
