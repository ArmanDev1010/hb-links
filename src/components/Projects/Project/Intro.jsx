...
export default function Intro({ title, bg_img, details }) {
  ...
  return (
    <div ref={wrapper} className="relative w-full h-[110vh]">
      <div className="absolute inset-0 brightness-[40%] -z-10" ref={background}>
        <Image
          src={bg_img}
          fill={true}
      ...
      >
        <h1 className="text-white text-[5.5vw] text-center uppercase border-b border-b-white mb-[2rem]">
          {title}
        </h1>
